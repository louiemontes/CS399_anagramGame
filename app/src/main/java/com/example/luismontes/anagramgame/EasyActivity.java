...
public class EasyActivity extends AppCompatActivity {
    ...
    public String[] wordBank = {"camp","tribe","fire"};
    private Random rand = new Random();
    private int secondsLeft = 30;

    // Making references for XML elements
    private Button goBackFromEasy;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goBackFromEasy = (Button) findViewById(R.id.goBackFromEasy);
        goBackFromEasy.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void showScore(int secondsLeft, int numberCorrect) {
        ...
        intent.putExtra("answersCorrect", numberCorrect);
        startActivity(intent);
    }
}